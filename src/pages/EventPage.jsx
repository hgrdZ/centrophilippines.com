    ...
    <div className="flex min-h-screen bg-no-repeat bg-center bg-cover" style={{backgroundImage: `url(${CentroAdminBg})`, backgroundSize: "100% 100%"}}>
      ...
      <main className="flex-1 ml-64 p-6 overflow-y-auto">
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className={`${getHeaderColor(eventData.event_id)} text-center rounded-t-full py-3 font-montserrat font-bold text-3xl shadow-md text-emerald-900 border-emerald-800 cursor-pointer hover:opacity-90 transition-opacity`} title="Click to edit Event Title">
            ...
            <div className="flex-1 pr-4 space-y-6">
              ...
              <div className="flex gap-6">
                <div className="flex-1 rounded-lg overflow-hidden shadow-lg cursor-pointer hover:opacity-90 transition-all" title="Click to edit Event Image">
                  {eventImage ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center text-center text-emerald-900 bg-gray-100 rounded-lg min-h-[200px]">
              ...
              <div className="flex justify-center space-x-4 pt-4">
                <Link to={`/event/${eventData.event_id}/first`}>
                  <button className="bg-emerald-900 text-white font-montserrat font-semibold px-8 py-3 rounded-lg hover:bg-emerald-700 shadow-lg transition-colors cursor-pointer">Review Certifications</button>
                </Link>
              </div>
            </div>
