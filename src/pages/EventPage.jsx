        ...
        <div className="bg-white rounded-lg shadow overflow-hidden h-full flex flex-col">
          ...
          <div className={`${getHeaderColor(eventData.event_id)} rounded-t-full py-3 font-montserrat font-bold text-3xl shadow-md text-emerald-900 border-emerald-800 relative`}>
            <button
              ...
              className="absolute left-1 top-3 -translate-y-1 bg-white text-emerald-900 font-montserrat font-semibold px-2 py-0 rounded-lg hover:bg-emerald-50 shadow-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1 text-sm"
            >
              {isGeneratingReport ? (
                <>
