      ...
      html: `
        ...
        <head>
          ...
          <style>
            ...
            .header { background: linear-gradient(135deg, #b91c1c 0%, #991b1b 100%); color: white; padding: 40px 30px; text-align: center; }
            ...
            .reason-title { color: #dc2626; font-weight: 600; font-size: 15px; margin-bottom: 12px; }
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p class="message">We are writing to inform you that your volunteer application with <strong>${ngoName}</strong> has been rejected.</p>
              <div class="reason-box">
                <div class="reason-title">Reason for Rejection</div>
                <div class="reason-text">${reason}</div>
              </div>
              <p class="message">We encourage you to apply again in the future.</p>
              <div class="signature">
                <p>Best regards,</p>
