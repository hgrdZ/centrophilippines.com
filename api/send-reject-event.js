...
module.exports = async (req, res) => {
  ...
  try {
    const data = await resend.emails.send({
      from: 'Centro App <notifications@centrophilippines.online>', // Ensure this domain is verified in Resend
      to: [recipientEmail],
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p class="message">Thank you for your interest in joining the event <strong>${eventTitle}</strong> organized by <strong>${ngoName}</strong>. After a careful review of your application, we regret to inform you that your participation request has been <strong>rejected</strong> at this time.</p>
              <div class="reason-box">
                <div class="reason-title">Reason for Rejection</div>
                <div class="reason-text">${reason}</div>
              </div>
              <p class="message">We appreciate your enthusiasm and your willingness to contribute as a volunteer. Please know that this decision does not reflect negatively on your abilities or potential. You are always welcome to apply for future events or opportunities within our organization.</p>
              <div class="signature">
                <p>Best regards,</p>
